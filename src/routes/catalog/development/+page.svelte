<!-- src/routes/catalog/development/+page.svelte -->
<script lang="ts">
  ...
  const startCursor: string = '0000' /* Начало диапазона DevID для данной категории */
  const endCursor: string = '0FFF' /* Конец диапазона DevID для данной категории */
...
<!-- Разметка компонента -->
<h2>{t('catalog.development.title', currentLang)}</h2>
