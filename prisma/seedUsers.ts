  ...
  const SeedUsersData = [
    {
      ...
      Password: '$argon2id$v=19$m=65536,t=3,p=4$5vz60qSgZZp83hr4R7fmSQ$izWUQ7K6Ezfe0zQwN7i268/z0o8sPxh1Bqqq2V4tkhY',
      NickName: 'VD',
      Avatar: '',
      FirstName: 'Владимир',
      LastName: 'Дорогостоянов',
    ...
    },
    {
      ...
      IsOnline: false,
      Role: 'USER',
      EMail: 'user_105@gmail.com',
      Password: '$argon2id$v=19$m=65536,t=3,p=4$pjxmhP5Gc2vKzG8IiLROCg$Oz0lJfLv+iNw7twapLrD9x0GdcI/+epZ/u1grQCq1bA',
      NickName: 'AS',
      Avatar: '',
      FirstName: 'Александр',
      LastName: 'Сидоренко',
      AboutMe: 'Пользователь системы',
      Country: 'Беларусь',
      Region: 'Гомельская обл.',
      City: 'Гомель',
      Address: 'ул. Советская 5',
      PostCode: '246007',
      PhoneNumber: '+375293121217',
      Tags: DEFAULT_TAGS,
    },
    {
      IsActivated: true,
      IsOnline: false,
      Role: 'MANAGER',
      EMail: 'user_106@gmail.com',
      Password: '$argon2id$v=19$m=65536,t=3,p=4$VRTiAycEtJ/gd8AN9qrkBw$eUj2CI/V+zhdBdCU4KsKg3A+JaQFYAGnS/0fIArNvxI',
      NickName: 'Union',
      Avatar: '',
      FirstName: 'Дмитрий',
      LastName: 'Карамбаев',
    ...
    },
    {
      ...
      IsOnline: false,
      Role: 'ENGINEER',
      EMail: 'user_107@gmail.com',
      Password: '$argon2id$v=19$m=65536,t=3,p=4$Y9a5F2DFudHFVSQlSGGbHg$3LJdK1AGZt0WM0qCyAtnReXDeg/ujW8b67HaGiFBxXA',
      NickName: 'ePod',
      Avatar: '',
      FirstName: 'Екатерина',
      LastName: 'Подорожная',
    ...
    },
    {
      ...
      IsOnline: false,
      Role: 'ADMIN',
      EMail: 'user_108@gmail.com',
      Password: '$argon2id$v=19$m=65536,t=3,p=4$m/27h7k6BRK2kg6esjjJfw$ro+4syYUaVnpUPS9wnrCB6K+IF7Tg4Qymssn3YXbqa8',
      NickName: 'LKovalova',
      Avatar: '',
      FirstName: 'Людмила',
      LastName: 'Ковалева',
    ...
    },
    {
      ...
      IsOnline: false,
      Role: 'USER',
      EMail: 'user_109@gmail.com',
      Password: '$argon2id$v=19$m=65536,t=3,p=4$IiDCrPuYnG0KsbgdyLoKTQ$AaXXXaxTvngBosdpzgzl6UfT+Q912zEX/Hs9onpkpOU',
      NickName: 'TaSkey',
      Avatar: '',
      FirstName: 'Тимофей',
      LastName: 'Стародубов',
